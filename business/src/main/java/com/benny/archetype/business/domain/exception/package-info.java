 ...
 * 自定义异常类需要配置<code> config/common.properties 中的 assertutil.exception.class.name项 </code>, {@link com.benny.archetype.common.framework.config.ConfigKeyEnum#ASSERTUTIL_EXCEPTION_CLASS_NAME}<br/>
 * 自定义异常与通用异常工具配合使用更佳, {@link com.benny.archetype.common.framework.util.AssertUtil}<br/>
 * @author yin.beibei
 * @date 2018/11/19 16:35
 */
package com.benny.archetype.business.domain.exception;